...
class SerialExecutor<T> implements Executor, ForeachContext<T> {
  ...
  private UnorderedWorklist<T> worklist;
  ...
  @Override
  public void onCommit(Iteration it, Lambda0Void call) {
  ...
  public IterationStatistics call(Lambda2Void<T, ForeachContext<T>> body, UnorderedWorklist<T> worklist)
  ...
  @Override
  public void suspendWith(Lambda0Void call) {
    suspendThunks.addFirst(call);
    yield = true;
  }
