...
class ConcurrentBoundedLIFO<T> extends ConcurrentLIFO<T> {
  public ConcurrentBoundedLIFO(Lambda0<Worklist<T>> maker, boolean needSize) {
    super(maker, needSize);
  }

  public ConcurrentBoundedLIFO(int maxElements, Lambda0<Worklist<T>> maker, boolean needSize) {
    super(maker, needSize);
  }
}
