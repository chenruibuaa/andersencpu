...
public class ChunkedLIFO<T> implements Worklist<T> {
   ...
   */
  public ChunkedLIFO(Lambda0<Worklist<T>> maker, boolean needSize) {
   ...
   */
  public ChunkedLIFO(int chunkSize, Lambda0<Worklist<T>> maker, boolean needSize) {
    this(chunkSize, maker.call(), needSize);
  }
