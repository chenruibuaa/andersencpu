...
public class ChunkedFIFO<T> implements Worklist<T> {
   ...
   */
  public ChunkedFIFO(Lambda0<Worklist<T>> maker, boolean needSize) {
   ...
   */
  public ChunkedFIFO(int chunkSize, Lambda0<Worklist<T>> maker, boolean needSize) {
    this(chunkSize, null, maker.call(), needSize);
  }
