...
public interface DoubleGraph<N extends GObject> extends Graph<N> {
   ...
   */
  public double getDoubleEdgeData(GNode<N> src, GNode<N> dst);
   ...
   * @return the data associated with the edge, or -1 if the edge does not exist
   */
  public double getDoubleEdgeData(GNode<N> src, GNode<N> dst, byte flags);
   ...
   */
  public double setDoubleEdgeData(GNode<N> src, GNode<N> dst, double d);
   ...
   * @return the data previously associated with the edge, or -1 if the edge does not exist
   */
  public double setDoubleEdgeData(GNode<N> src, GNode<N> dst, double d, byte flags);
}
