...
class SerialRefinementIntGraph<N extends GObject> implements IntGraph<N>, BuilderGraph<N,Integer> {
  ...
  public SerialRefinementIntGraph(int numNodes) {
    nodes = new SerialRefinementIntGraph.Node[numNodes];
