 ...
 * rather through {@link galois.runtime.GaloisRuntime#forall(Mappable, LambdaVoid)}
 * and its variants, which set up the appropriate {@link PmapContext}
 * objects.
 * 
 * <p>
...
public interface Mappable<T> {
  /**
   * Signals to instance that concurrent iteration is about to begin.
   ...
   * Not intended to be called directly.
   * 
   * @see galois.runtime.GaloisRuntime#forall(Mappable, LambdaVoid)
