 ...
 * 
 */
class SerialLocalComputationGraph<N extends GObject, E> implements BuilderGraph<N,E>, BuilderGraphData<N,E>, AllGraph<N,E> {
  ...
  public SerialLocalComputationGraph(GraphData g, NodeData<N> nodeData, EdgeData<E> edgeData, boolean undirected) {
    this.g = g;
    this.nodeData = nodeData;
    this.edgeData = edgeData;
    this.undirected = undirected;
    nodes = new SerialLocalComputationGraph.Node[g.getNumNodes()];
  ...
  protected class Node extends ConcurrentGNode<N> {
    ...
    final boolean contains(SerialLocalComputationGraph<N, E> g) {
      return SerialLocalComputationGraph.this == g;
    }
