...
public interface FloatGraph<N extends GObject> extends Graph<N> {
   ...
   */
  public float getFloatEdgeData(GNode<N> src, GNode<N> dst);
   ...
   * @return the data associated with the edge, or -1 if the edge does not exist
   */
  public float getFloatEdgeData(GNode<N> src, GNode<N> dst, byte flags);
   ...
   */
  public float setFloatEdgeData(GNode<N> src, GNode<N> dst, float d);
   ...
   * @return the data previously associated with the edge, or -1 if the edge does not exist
   */
  public float setFloatEdgeData(GNode<N> src, GNode<N> dst, float d, byte flags);
}
