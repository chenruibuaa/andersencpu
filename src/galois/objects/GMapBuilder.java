 ...
 * @see GMap
 */
public class GMapBuilder<K extends GObject, V extends GObject> {
  /**
   * Creates a new map.
   * 
   * @param <K>
  ...
  private static class SerialGMap<K extends GObject, V extends GObject> implements GMap<K, V> {
  ...
  private static class ConcurrentGMap<K extends GObject, V extends GObject> implements GMap<K, V> {
    private Map<K, V> map;
    ...
    @SuppressWarnings("unchecked")
    public V get(Object arg0, byte keyFlags, byte valueFlags) {
      Iteration.access((K) arg0, keyFlags);
      V retval = map.get(arg0);
      if (retval != null) {
        Iteration.access(retval, valueFlags);
      }
      return retval;
    }
    ...
    public V put(final K arg0, V arg1, byte keyFlags, byte valueFlags) {
      Iteration it = Iteration.access(arg0, keyFlags);
      final V retval = map.put(arg0, arg1);
      final boolean hadEntry = retval != null;
      if (it != null && GaloisRuntime.needMethodFlag(keyFlags, MethodFlag.SAVE_UNDO)) {
    ...
    public V remove(final Object arg0, byte keyFlags, byte valueFlags) {
      Iteration it = Iteration.access((K) arg0, keyFlags);
      final V retval = map.remove(arg0);
      final boolean hadEntry = retval != null;
      if (hadEntry && it != null && GaloisRuntime.needMethodFlag(keyFlags, MethodFlag.SAVE_UNDO)) {
        GaloisRuntime.getRuntime().onUndo(it, new Lambda0Void() {
          @Override
          public void call() {
