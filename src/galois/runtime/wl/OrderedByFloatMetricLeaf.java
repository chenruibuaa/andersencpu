...
class OrderedByFloatMetricLeaf<T> extends OrderedByFloatMetric<T> {
  /**
   * Creates an ascending order
   * 
   * @param indexer     function mapping elements to integers 
   */
  public OrderedByFloatMetricLeaf(float range, Lambda<T, Float> indexer, Lambda0<Worklist<T>> maker, boolean needSize) {
   ...
   * 
   * @param descending   true if ascending order, otherwise descending
   * @param indexer     function mapping elements to integers 
   */
  public OrderedByFloatMetricLeaf(float range,  Lambda<T, Float> indexer, boolean descending, int numBuckets,boolean approxMonotonic, Lambda0<Worklist<T>> maker, boolean needSize) {
