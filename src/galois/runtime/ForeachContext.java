 ...
 * ({@link #suspendWith(Lambda0Void)}), and finish executing the
 ...
 * commits. In the case of {@link #suspendWith(Lambda0Void)} and
 ...
 */
public interface ForeachContext<T> extends ThreadContext {
  /**
